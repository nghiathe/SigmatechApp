...
class AuthenticationRepository extends GetxController {
  ...
  Future<void> registerUser(String name, String email, String phone, String password, String passwordConfirm) async {
    try {
      final response = await _authService.register(name, email, phone, password, passwordConfirm);
